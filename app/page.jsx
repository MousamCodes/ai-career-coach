...
import {  Briefcase, Clock, ArrowRight, Link as Linkicon } from "lucide-react";
...
<section className="w-full">
  <div className="mx-auto py-24 px-4 md:px-6 rounded-lg bg-gradient-to-b from-gray-300 via-gray-400 to-gray-600">
    <div className="flex flex-col items-center justify-center space-y-5 text-center max-w-3xl mx-auto">
      ...
      <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl ">
        Join 1000+ users already building AI-powered resumes 
      ...
      size="lg"
      variant="secondary"
      className="h-12 mt-6 animate-bounce w-54"
    >
    Boost My Career <ArrowRight className="ml-4 h-6 w-8" />
  </Button>
   </Link>
